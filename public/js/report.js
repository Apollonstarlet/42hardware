$(document).ready(function () {
    ...
    var stock_report_cols = [
        ...
        { data: 'category_name', name: 'c1.name' },
        { data: 'sub_category_name', name: 'c2.name' },
    ...
    //     { data: 'total_sale_without_tax', name: 'total_sale_without_tax' },
    //     { data: 'total_sale_gross', name: 'total_sale_gross' },
    //     { data: 'p_sale_gross', name: 'p_sale_gross' },
    //     { data: 'unit_cost_inc_tax', name: 'unit_cost_inc_tax' },
    //     { data: 'avg_unit_cost_inc_tax', name: 'avg_unit_cost_inc_tax' },
    //     { data: 'total_avg_cost', name: 'total_avg_cost' },
    //     { data: 'gross_profit', name: 'gross_profit' },
    //     { data: 'p_gross_profit', name: 'p_gross_profit' },
    //     { data: 'p_gross_margin', name: 'p_gross_margin' },
    // ];
...
// $(document).on('change', 'input[name="profit_loss_reporttype"]', function() {
//     updateProfitLoss();
// });
// $(document).on('change', '#profit_loss_displaytype', function() {
//     updateProfitLoss();
// });