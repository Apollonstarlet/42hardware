...
Route::middleware(['authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('taxonomies-ajax-index-page', 'TaxonomyController@getTaxonomyIndexPage');
     Route::post('taxonomies-is-pos-upate','TaxonomyController@updateIsPos');
    ...
    Route::get('/reports/product-profitibility-report', 'ReportController@getProductProfitibity');
    Route::post('/reports/get-product-profit-details', 'ReportController@getProductProfitDetails');
    Route::post('/reports/get-ageing-details', 'ReportController@getAgeingDetails');
    ...
    Route::post('purchasedocument', 'PurchaseController@getPurchaseDocument');

    Route::get('/reports/supplier-ageing', 'ReportController@getSuppliersAgeing')->name('supplier-ageing');
    Route::post('/reports/get-expanse-details', 'ReportController@getExpanseDetails')->name('get-expanse-details');
    Route::post('/reports/get-sales-details', 'ReportController@getSalesDetails')->name('get-sales-details');
