<script type="text/javascript">
    function updateIsPos(id,ispos) {
         $.ajax({
            method: "post",
            dataType: "json",
            url: '/taxonomies-is-pos-upate',
            data: {id:id,ispos:ispos},
            async: false,
            success: function(result){
               toastr.success("Pos Item setting successfully.");
            }
        });
    }
            ...
            if ($('#category_table').length) {
                ...
                category_table = $('#category_table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'ispos', name: 'ispos' , orderable: false, searchable: false },
