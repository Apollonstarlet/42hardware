<tr class="product_row" data-row_index="{{$row_count}}">
	<td>
		...
		<span class="text-linkd text-infod text-black cursor-pointer" data-toggle="modal" data-target="#row_edit_product_price_modal_{{$row_count}}">
			{!! $product_name !!}
	...
	<td class="text-center v-center">
	    	<span class="display_currency pos_line_real_total @if(!empty($pos_settings['is_pos_subtotal_editable'])) hide @endif" data-currency_symbol="true">{{$product->quantity_ordered*$unit_price_inc_tax}}</span>
	</td>
