<table class="table bg-gray">
    ...
    @foreach($sell->sell_lines as $sell_line)
        <tr>
            ...
            <td>
                <span class="display_currency" data-currency_symbol="true">{{ round($sell_line->quantity * $sell_line->unit_price_inc_tax +  $sell_line->quantity * $sell_line->unit_price_inc_tax * 16/100)}}</span>
            </td>
        </tr>
